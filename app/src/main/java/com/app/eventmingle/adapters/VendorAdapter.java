...
public class VendorAdapter extends RecyclerView.Adapter<VendorAdapter.VH> {
    ...
    public interface OnDeleteListener {
        void onDelete(Vendor v);
    }

    private final List<Vendor> vendors;
    private final OnAddListener addL;
    private final OnDeleteListener delL;

    public VendorAdapter(List<Vendor> vendors,
                         OnAddListener addListener,
                         OnDeleteListener deleteListener) {
        this.vendors = vendors;
        this.addL = addListener;
        this.delL = deleteListener;
    }
    ...
    public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        if (addL != null) {
            h.btnAddToEvent.setVisibility(View.VISIBLE);
            h.btnAddToEvent.setOnClickListener(__ -> addL.onAdd(v));
        } else {
            h.btnAddToEvent.setVisibility(View.GONE);
        }
        ...
        if (delL != null) {
            ...
            h.btnDelete.setOnClickListener(__ -> delL.onDelete(v));
        } else {
    ...
    static class VH extends RecyclerView.ViewHolder {
        TextView vendorName, vendorServiceType, vendorAddress, vendorContact, vendorEmail, vendorDesc;
        Button btnAddToEvent,btnDelete;
